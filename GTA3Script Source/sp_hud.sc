...
LVAR_INT is_in_interior hud_mode is_hud_enabled is_opening_door //enter_status
LVAR_INT iTempVar idTex counter
...
drawCurrentPower:
    ...
    SWITCH idPowers
        ...
        CASE equalizer
            USE_TEXT_COMMANDS FALSE
            SET_SPRITES_DRAW_BEFORE_FADE TRUE
            DRAW_SPRITE idSPPowerEQ (535.0 50.0) (sx sy) (255 255 255 255)
            BREAK    
        CASE quad_damage
            USE_TEXT_COMMANDS FALSE
            SET_SPRITES_DRAW_BEFORE_FADE TRUE
...
drawHitCounter:
    ...
    IF iHitCounter > 0
        ...
        SET_TEXT_DRAW_BEFORE_FADE TRUE
        DISPLAY_TEXT_WITH_NUMBER 23.7 40.0 NUMBER iHitCounter
    ENDIF
*/
RETURN
//-+--------------------------------------------------------
