...
ProcessGame_and_DrawItems_SETTINGS:
    ...
    CLEO_CALL GUI_DrawBoxOutline_WithText 0 (122.214 287.0) (75.0 34.0) (0 0 0 0) (0.6) (0 0 1 0) (236 255 255 80) -1 -1 (0.0 0.0)   //LINE DIVISION
    CLEO_CALL GUI_DrawBoxOutline_WithText 0 (217.214 287.0) (75.0 34.0) (0 0 0 0) (0.6) (0 0 1 0) (236 255 255 80) -1 -1 (0.0 0.0)   //LINE DIVISION
...
ProcessGame_and_DrawMenu_RightPanel_SUITS:
    ...
    IF iSelectedSuit = 3    // Classic Suit (Repaired)
        ...
        iSelectedPower = 1      // Web Blossom
        GOSUB DrawInfo_Suit_Unlocked_Power_RightPanel   
    ELSE    
        IF iSelectedSuit = 5    // Scarlet Spider Suit
            iTempVar = idSelectedSuitUnlocks    //THIS SUIT ALSO UNLOCKS 
            CLEO_CALL GUI_DrawBoxOutline_WithText 0 (572.5 122.5) (136.0 15.0) (16 43 52 0) (0.5) (0 0 0 0) (31 181 240 200) iTempVar 2 (-60.0 0.0)   //THIS SUIT ALSO UNLOCKS
            iSelectedPower = 2      // Holo Decoy
            GOSUB DrawInfo_Suit_Unlocked_Power_RightPanel
        ELSE
            IF iSelectedSuit = 6  // Spider Armour - MK II Suit
                iTempVar = idSelectedSuitUnlocks    //THIS SUIT ALSO UNLOCKS 
                CLEO_CALL GUI_DrawBoxOutline_WithText 0 (572.5 122.5) (136.0 15.0) (16 43 52 0) (0.5) (0 0 0 0) (31 181 240 200) iTempVar 2 (-60.0 0.0)   //THIS SUIT ALSO UNLOCKS
                iSelectedPower = 3      // Bullet Proof
                GOSUB DrawInfo_Suit_Unlocked_Power_RightPanel
            ELSE         
                IF iSelectedSuit = 8    // Stark Suit
                    iTempVar = idSelectedSuitUnlocks    //THIS SUIT ALSO UNLOCKS 
                    CLEO_CALL GUI_DrawBoxOutline_WithText 0 (572.5 122.5) (136.0 15.0) (16 43 52 0) (0.5) (0 0 0 0) (31 181 240 200) iTempVar 2 (-60.0 0.0)   //THIS SUIT ALSO UNLOCKS
                    iSelectedPower = 4      //
                    GOSUB DrawInfo_Suit_Unlocked_Power_RightPanel          
                ELSE     
                    IF iSelectedSuit = 9    // Negative Suit
                        iTempVar = idSelectedSuitUnlocks    //THIS SUIT ALSO UNLOCKS 
                        CLEO_CALL GUI_DrawBoxOutline_WithText 0 (572.5 122.5) (136.0 15.0) (16 43 52 0) (0.5) (0 0 0 0) (31 181 240 200) iTempVar 2 (-60.0 0.0)   //THIS SUIT ALSO UNLOCKS
                        iSelectedPower = 5      // Spider Bro
                        GOSUB DrawInfo_Suit_Unlocked_Power_RightPanel        
                    ELSE       
                        IF iSelectedSuit = 10   // Electrically Insulated Suit
                            iTempVar = idSelectedSuitUnlocks    //THIS SUIT ALSO UNLOCKS 
                            CLEO_CALL GUI_DrawBoxOutline_WithText 0 (572.5 122.5) (136.0 15.0) (16 43 52 0) (0.5) (0 0 0 0) (31 181 240 200) iTempVar 2 (-60.0 0.0)   //THIS SUIT ALSO UNLOCKS
                            iSelectedPower = 6      // Electric Punch
                            GOSUB DrawInfo_Suit_Unlocked_Power_RightPanel  
                        ELSE
                            IF iSelectedSuit = 11   // Spider-Punk
                                iTempVar = idSelectedSuitUnlocks    //THIS SUIT ALSO UNLOCKS 
                                CLEO_CALL GUI_DrawBoxOutline_WithText 0 (572.5 122.5) (136.0 15.0) (16 43 52 0) (0.5) (0 0 0 0) (31 181 240 200) iTempVar 2 (-60.0 0.0)   //THIS SUIT ALSO UNLOCKS
...
ProcessGame_and_DrawItems_Config_SUIT:
    CLEO_CALL GUI_DrawBoxOutline_WithText 0 (215.0 193.75) (260.0 257.5) (2 40 49 150) (0.6) (1 1 1 1) (0 125 180 200) -1 -1 (0.0 0.0)   //BLUE_BACK_MAIN_SUIT_MODS
    iTempVar = idSuitMods_l
    CLEO_CALL GUI_DrawBoxOutline_WithText 0 (215.0 80.0) (250.0 15.0) (6 253 244 0) (0.6) (0 0 1 0) (6 253 244 200) iTempVar 2 (-110.0 0.0)   //TITLE_SUIT_MODS
    //----lines side - left
    CLEO_CALL GUI_DrawBoxOutline_WithText 0 (81.25 80.0) (7.5 15.0) (6 253 244 0) (0.55) (0 0 1 0) (6 253 244 200) -1 -1 (0.0 0.0)   //LINE_SIDE_LEFT (SUIT-)
    USE_TEXT_COMMANDS FALSE
    DRAW_RECT (77.5 87.5) (2.5 2.5) (6 253 244 200)
    CLEO_CALL GUI_DrawBoxOutline_WithText 0 (73.75 220.0) (7.5 15.0) (6 253 244 0) (0.55) (0 0 1 0) (6 253 244 200) -1 -1 (0.0 0.0)   //LINE_SIDE_LEFT (SUIT_MOD-)
    USE_TEXT_COMMANDS FALSE
...
ProcessGame_and_DrawItems_SUITS:
    ...
    IF iActiveRow = 0
        IF iMinRowSuitQuantity = 16
            iActiveRow = 1
            iMinRowSuitQuantity = 11
            iMaxRowQuantity = 15   //3nd Row
        ENDIF
    ENDIF          
    IF iActiveRow = 0
        IF iMinRowSuitQuantity = 21
            iActiveRow = 1
            iMinRowSuitQuantity = 16
            iMaxRowQuantity = 20   //4th Row
        ENDIF
    ENDIF    
    ...
    iTempVar = idSuit_l
    CLEO_CALL GUI_DrawBoxOutline_WithText 0 (215.0 80.0) (250.0 15.0) (6 253 244 0) (0.6) (0 0 1 0) (6 253 244 200) iTempVar 2 (-110.0 0.0)   //TITLE_SUIT
    
    CLEO_CALL GUI_DrawBoxOutline_WithText 0 (77.5 80.0) (15.0 15.0) (6 253 244 0) (0.6) (0 0 1 0) (6 253 244 200) -1 -1 (0.0 0.0)   //LINE_SIDE_LEFT
    USE_TEXT_COMMANDS FALSE
    DRAW_RECT (77.5 87.5) (2.5 2.5) (6 253 244 200)
    ...
    WHILE 50 >= counter
        IF iSelectedSuit = counter
            SWITCH iSelectedSuit
                ...
                CASE 41
                    iTempVar = 8319
                    idTexture = idSuit41_l
                    BREAK   
                CASE 42
                    iTempVar = 4913
                    idTexture = idSuit42_l
                    BREAK 
                CASE 43
                    iTempVar = 6743
                    idTexture = idSuit43_l
                    BREAK 
                CASE 44
                    iTempVar = 1232
                    idTexture = idSuit44_l
                    BREAK  
                CASE 45
                    iTempVar = 6731
                    idTexture = idSuit45_l
                    BREAK  
                CASE 46
                    iTempVar = 2846
                    idTexture = idSuit46_l
                    BREAK  
                CASE 47
                    iTempVar = 1985
                    idTexture = idSuit47_l
                    BREAK
                CASE 48
                    iTempVar = 6744
...
ProcessGame_and_DrawItems_POWER_SUITS:
    ...
    CLEO_CALL GUI_DrawBoxOutline_WithText 0 (85.0 120.0) (15.0 65.0) (6 253 244 0) (0.5) (0 0 0 1) (6 253 244 200) -1 -1 (0.0 0.0)   //LINE_SIDE_LEFT (VERTICAL+UNION)
    //---------
    //GET_FIXED_XY_ASPECT_RATIO (55.0 55.0) (xSize ySize) //40.0 35.0
    xSize = 41.25
    ySize = 51.33
...
//251.5
//412.5
    CLEO_CALL GUI_DrawBoxOutline_WithText 0 (90.5 220.0) (141.0 290.0) (22 44 55 100) (0.65) (1 1 1 1) (58 158 156 150) -1 -1 (0.0 0.0)     // BACKGROUND
    CLEO_CALL GUI_DrawBoxOutline_WithText 0 (90.5 90.0) (120.0 30.0) (0 0 0 0) (0.6) (0 0 1 0) (58 158 156 150) 629 13 (0.0 -2.0)     //Innovator

    CLEO_CALL GUI_DrawBoxOutline_WithText 0 (251.5 220.0) (141.0 290.0) (22 44 55 100) (0.65) (1 1 1 1) (58 158 156 150) -1 -1 (0.0 0.0)     // BACKGROUND
    CLEO_CALL GUI_DrawBoxOutline_WithText 0 (251.5 90.0) (120.0 30.0) (0 0 0 0) (0.6) (0 0 1 0) (58 158 156 150) 628 13 (0.0 -2.0)     //Defender
    
    CLEO_CALL GUI_DrawBoxOutline_WithText 0 (412.5 220.0) (141.0 290.0) (22 44 55 100) (0.65) (1 1 1 1) (58 158 156 150) -1 -1 (0.0 0.0)     // BACKGROUND
    CLEO_CALL GUI_DrawBoxOutline_WithText 0 (412.5 90.0) (120.0 30.0) (0 0 0 0) (0.6) (0 0 1 0) (58 158 156 150) 627 13 (0.0 -2.0)     //Defender
...
//Skill Tree # 3
    ...
    yCoord = 175.0
    USE_TEXT_COMMANDS FALSE
    DRAW_RECT (xCoord yCoord) (73.0 0.5) (255 255 255 180) //horizontal
...
DrawInfo_SKILLS_RightPanel:
    ...
    CLEO_CALL GUI_DrawBoxOutline_WithText 0 (535.75 214.0) (63.5 17.5) (16 43 52 0) (0.45) (1 0 0 0) (31 181 240 200) -1 -1 (0.0 0.0)   //LINE_LEFT
    CLEO_CALL GUI_DrawBoxOutline_WithText 0 (633.75 214.0) (12.5 17.5) (16 43 52 0) (0.45) (1 0 0 0) (31 181 240 200) -1 -1 (0.0 0.0)   //LINE_RIGHT
    CLEO_CALL GUI_DrawBoxOutline_WithText 0 (597.5 207.0) (60.0 17.5) (16 43 52 0) (0.55) (1 1 1 1) (31 181 240 200) -1 -1 (0.0 0.0)   //SIDES_LINES
    iTempVar = idOwned_l
...
ProcessGame_and_DrawItems_MOVES:
    ...
    CLEO_CALL GUI_DrawBoxOutline_WithText 0 (200.0 53.0) (170.0 31.0) (0 0 1 0) (0.45) (0 0 1 0) (0 125 180 200) 209 13 (0.0 0.0)   //ON FOOT
    CLEO_CALL GUI_DrawBoxOutline_WithText 0 (200.0 227.0) (170.0 31.0) (0 0 1 0) (0.45) (0 0 1 0) (0 125 180 200) 208 13 (0.0 0.0)   //ON AIR
    ...
    WHILE iColumn >= iRow   //210->225
        CLEO_CALL GUI_DrawBoxOutline_WithText 0 (xCoord yCoord) (145.0 18.0) (0 0 0 0) (0.65) (0 0 1 0) (0 125 180 200) iRow 5 (0.0 0.0)   //TEXT
        xCoord += 145.0
        IF IS_PC_USING_JOYPAD
            iRow += 40
            CLEO_CALL GUI_DrawBoxOutline_WithText 0 (xCoord yCoord) (145.0 18.0) (0 0 0 0) (0.65) (0 0 1 0) (0 125 180 200) iRow 5 (0.0 0.0)   //KEYS
            xCoord -= 145.0
            iRow -= 40
        ELSE
            iRow += 20
...
//-+------------------------------------------
        ...
        LOAD_SPRITE suit36 "suit36"
        LOAD_SPRITE suit37 "suit37"
        LOAD_SPRITE suit38 "suit38"
        LOAD_SPRITE suit39 "suit39"
        LOAD_SPRITE suit40 "suit40"
        LOAD_SPRITE suit41 "suit41"
        LOAD_SPRITE suit42 "suit42"
        LOAD_SPRITE suit43 "suit43"
        LOAD_SPRITE suit44 "suit44"
        LOAD_SPRITE suit45 "suit45"
        LOAD_SPRITE suit46 "suit46"
...
CONST_INT idSuit36_l            683
CONST_INT idSuit37_l            684
CONST_INT idSuit38_l            685
CONST_INT idSuit39_l            686
CONST_INT idSuit40_l            687
CONST_INT idSuit41_l            688
CONST_INT idSuit42_l            689
CONST_INT idSuit43_l            690
CONST_INT idSuit44_l            691
CONST_INT idSuit45_l            692
CONST_INT idSuit46_l            693
